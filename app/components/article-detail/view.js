  ...
  render() {
    ...
    return (
      <div className="article-detail">
        ...
        <div className={`blog-content ${markdown == '1' ? "markdown-wrap" : ""}`} dangerouslySetInnerHTML={{__html: body}}></div>
      </div>
    )
  }
}
...
export default connect(mapStateToProps, mapDispatchProps)(ArticleDetail)